      ...
      <div className="grid items-center gap-10 sm:grid-cols-2">
        <ScrollReveal>
          ...
          <h2 className="font-display text-3xl leading-tight sm:text-4xl">
            <span aria-hidden="true">&#128274;</span> The world never runs ahead
            of you.
          </h2>
          <p className="mt-4 max-w-md font-ui text-sm leading-relaxed text-[var(--muted-foreground)]">
            Everything is gated by where YOU are in the book. Characters, places
            and world reference unlock exactly as you reach them — never a page
            sooner.
          </p>
        </ScrollReveal>
        ...
        <ScrollReveal delayMs={120}>
          <div className="relative overflow-hidden rounded-lg border border-[var(--world-frame)] bg-[var(--world-surface)] p-6">
            <div
              className="space-y-2 blur-[3px] select-none"
              aria-hidden="true"
            >
            ...
            <div className="mt-5 flex justify-center">
              <span className="rounded-full border border-[var(--world-frame)] bg-[var(--background)] px-4 py-1.5 font-ui text-xs text-[var(--muted-foreground)]">
